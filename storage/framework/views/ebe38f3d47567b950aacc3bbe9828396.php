                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="d-flex flex-wrap gap-2 mb-4">
                                    <?php if(auth()->guard()->check()): ?>
                                        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary"><i class="bi bi-speedometer2"></i> Ke Dashboard</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary"><i class="bi bi-box-arrow-in-right"></i> Login</a>
                                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-secondary"><i class="bi bi-person-plus"></i> Daftar</a>
                                    <?php endif; ?>
                                </div>
                                <div class="row g-3">
                                    <div class="col-sm-6">
...
</html><?php /**PATH C:\laragon\www\perpustakaan-app\resources\views/welcome.blade.php ENDPATH**/ ?>